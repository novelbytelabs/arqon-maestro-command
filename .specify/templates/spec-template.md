...
for human-facing surfaces), model provenance records for promoted adapters/models,
artifact pinning by version + checksum from approved manifests, and explicit
promotion gates (deterministic outcome, fail-closed safety, p95 latency,
false-positive, evidence-packet contract validation).
